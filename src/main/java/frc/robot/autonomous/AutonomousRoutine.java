...
/**
 * Represents an autonomous routine, and also keeps track with a registry
 * to allow selecting though shuffleboard with an optional [0, 15] second delay
 */
public class AutonomousRoutine {
        ...
        public static void initShuffleboard() {
                ...
                for (double i = 0; i < 15; i += 0.25)
                        AUTO_DELAY_CHOOSER.addOption(String.format("%.2f", i), i);
