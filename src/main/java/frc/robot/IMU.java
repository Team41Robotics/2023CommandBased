...
public class IMU {
        ...
        public void zeroYaw(){ yawOffset = -ahrs.getYaw(); }
        public double getPitch() { return ahrs.getPitch() * Math.PI/180; }
        public double getRoll() { return ahrs.getRoll() * Math.PI/180; }
        public double getYaw() { return ((-ahrs.getYaw() - yawOffset) * Math.PI/180); }
        public double getAngle() { return (-ahrs.getAngle() - yawOffset) * Math.PI/180; }
}